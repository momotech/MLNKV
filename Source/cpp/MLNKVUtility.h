...
static inline int16_t MLNKVRawVarUInt32Size(uint32_t value) {
...
static inline int16_t MLNKVRawVarUInt64Size(uint64_t value) {
...
static const int16_t MLNKV32Size = 4;

static const int16_t MLNKV64Size = 8;
//
////// 判断机器模式 大小端
/////**
...
static inline uint32_t MLNKVReadUInt32(uint8_t* ptr, int16_t size) {
    uint32_t value = 0;
...
static inline uint64_t MLNKVReadUInt64(uint8_t* ptr, int16_t size) {
    uint64_t value = 0;
    for (int16_t i = 0; i < size; i++) {
...
static inline bool MLNKVWriteUInt32(uint8_t* ptr, uint32_t value, int16_t size) {
    for (int16_t i = 0; i < size; i++) {
...
static inline bool MLNKVWriteUInt64(uint8_t* ptr, uint64_t value, int16_t size) {
    for (int16_t i = 0; i < size; i++) {
        ptr[i] = (uint8_t)(value & 0xFF);
        value = value >> 8;
    }
